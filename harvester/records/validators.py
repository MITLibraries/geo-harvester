...
class ValidateGeoshapeWKT:
    ...
    The validator should be applied to any field methods that retrieve geoshape WKT values.
    The validator logs a warning if the WKT value cannot be parsed using the shapely module.
    If the WKT value cannot be parsed, the validator resets the value to None.
